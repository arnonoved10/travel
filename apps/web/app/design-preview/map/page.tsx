  ...
  return (
    <div ref={pageWrapRef} style={{ width: "100%", height: "100dvh", maxHeight: "100dvh", background: COLOR.pageBg, color: COLOR.textPrimary, fontFamily: "var(--font-rubik), sans-serif", direction: "rtl", display: "flex", flexDirection: "column", overflow: "hidden", paddingBottom: `${NAV_HEIGHT}px` }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "8px", padding: "8px 16px 4px", flexShrink: 0 }}>
        <Link href="/design-preview/route" aria-label="חזרה" style={{ width: "34px", height: "34px", borderRadius: "50%", background: COLOR.cardBg, border: `1px solid ${COLOR.cardBorder}`, color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, textDecoration: "none" }}>
      ...
      {stop ? (
        ...
        >
          ...
          <Link href={`/design-preview/planner?day=${stop.dateStart}&city=${encodeURIComponent(stop.city)}`} style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "6px", padding: "11px", borderRadius: "12px", background: "rgba(138,90,223,0.22)", border: `1px solid ${COLOR.purple}70`, color: "#c9b3ff", fontSize: "13.5px", fontWeight: 700, textDecoration: "none" }}>
