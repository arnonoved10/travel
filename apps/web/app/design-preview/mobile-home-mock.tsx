    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", direction: "ltr", fontSize: "13px", fontWeight: 700 }}>
          <span>{formatClockTime(now, Intl.DateTimeFormat().resolvedOptions().timeZone)}</span>
        ...
        <Link href="/design-preview/route" style={{ display: "block", textDecoration: "none", color: "inherit" }}>
        ...
        <Link href="/design-preview/wallet" style={{ display: "block", textDecoration: "none", color: "inherit" }}>
          <Card style={{ cursor: "pointer" }}>
      ...
      >
        {[
          { Icon: HouseNavIcon, label: "בית", active: true, href: "/design-preview" },
          { Icon: SuitcaseNavIcon, label: "מסלול", active: false, href: "/design-preview/route" },
          { Icon: JournalNavIcon, label: "יומן", active: false, href: "/design-preview/planner?day=2026-05-04&city=%D7%91%D7%A0%D7%92%D7%A7%D7%95%D7%A7" },
          { Icon: WalletNavIcon, label: "ארנק", active: false, href: "/design-preview/wallet" },
          { Icon: MoreNavIcon, label: "עוד", active: false, href: "/design-preview/more" },
        ...
        <>
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "2px" }}>
              {[
                { icon: <HouseNavIcon size={19} color={COLOR.textPrimary} />, label: "דף הבית", href: "/design-preview" },
                { icon: <SuitcaseNavIcon size={19} color={COLOR.textPrimary} />, label: "המסלול שלי", href: "/design-preview/route" },
                { icon: <JournalNavIcon size={19} color={COLOR.textPrimary} />, label: "היומן היומי", href: "/design-preview/planner?day=2026-05-04&city=%D7%91%D7%A0%D7%92%D7%A7%D7%95%D7%A7" },
                { icon: <WalletNavIcon size={19} color={COLOR.textPrimary} />, label: "הארנק שלי", href: "/design-preview/wallet" },
